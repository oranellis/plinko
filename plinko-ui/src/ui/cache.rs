...
use super::icons::{
    ...
    build_icon_person, build_icon_planning, build_icon_plus, build_icon_search,
...
// ── Implementation ──────────────────────────────────────────────────────────── {{{
impl RenderCache {
    /// Builds all cached resources.  Resolves a typeface via [`FontMgr`].
    pub fn new() -> Self {
        let font_mgr = FontMgr::new();
        let typeface = ["sans-serif", "DejaVu Sans"]
            .iter()
        ...
        let icon_search = build_icon_search(32.0, 32.0);
